...
if __name__ == '__main__':
    ...
    react_split = react.split("<")

    (react, bond_preds, bond_scores, cur_att_score) = directcorefinder.predict(react_split[0])
    ...
    for rct in next_reacts:
        ...
        for outcome in outcomes:
            ...
            new_two_step = []
            new_two_step.append(rct)
            new_two_step.append(outcome)
            all_two_steps.append(new_two_step)
    ...
    #directcandranker.load_model()
    ##outcomes = directcandranker.predict(react, bond_preds, bond_scores)
    #outcomes = directcandranker.predict(react, bond_preds, bond_scores) ## outputs dict with [rank, list of smiles, score, prob]
    ############################### repeat this, adding reactants step by step
    #for outcome in outcomes:
    #    print(outcome)
